...
export default async function IncidentsPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8">
      {/* Page Header */}
      <div>
        <h1 className="text-4xl font-bold gradient-text mb-2">Incidents</h1>
        <p className="text-gray-400">Track and manage service incidents</p>
      </div>
      ...
      {closedIncidents.length > 0 && (
        <div>
          ...
          <div className="space-y-3">
            {closedIncidents.slice(0, 10).map((incident) => {
